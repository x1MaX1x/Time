function currentTime() {
  ...
  function light(){
    ...
    document.querySelector('#clock').style.color = '#0008af'
    document.querySelector('#date').style.color = '#0008af'
  }
  function dark(){
    document.querySelector('body').style.background = 'black'
    document.querySelector('#clock').style.color = '#00FF99'
    document.querySelector('#date').style.color = '#00FF77'
  }
  function eavning(){
    document.querySelector('body').style.background = '#000a24'
    document.querySelector('#clock').style.color = '#31c4b9'
    document.querySelector('#date').style.color = '#31c4b9'
  }
  function day(){
    document.querySelector('body').style.background = 'white'
    document.querySelector('#clock').style.color = '#f1bf48'
    document.querySelector('#date').style.color = '#f1bf48'
  }
